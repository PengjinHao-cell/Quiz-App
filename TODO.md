...
> 版本：v1.3.0 · 更新日期：2026-06-07

---

## 待做

- [ ] **英汉词典集成** — 将 AiPlace/dictionary 融入 quiz-app，入口放在首页上传题库上方。暂缓原因：词典依赖 Free Dictionary API / MyMemory / Datamuse 等国外 API，国内用户直连不稳定或不可用。后续方案：后端代理或换成国内 API（有道/金山词霸等）。
